                ...
                groupReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        scheduleReference.addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                fridayFirstTV.setText(snapshot.child(scheduleId).child("week 1").child("friday").child("lesson 1").child("lessonName").getValue(String.class));
                                fridaySecondTV.setText(snapshot.child(scheduleId).child("week 1").child("friday").child("lesson 2").child("lessonName").getValue(String.class));
                                fridayThirdTV.setText(snapshot.child(scheduleId).child("week 1").child("friday").child("lesson 3").child("lessonName").getValue(String.class));
                                fridayFourthTV.setText(snapshot.child(scheduleId).child("week 1").child("friday").child("lesson 4").child("lessonName").getValue(String.class));
                                fridayFifthTV.setText(snapshot.child(scheduleId).child("week 1").child("friday").child("lesson 5").child("lessonName").getValue(String.class));
                                ...
                                name1 = snapshot.child(scheduleId).child("week 1").child("friday").child("lesson 1").child("teacherName").getValue(String.class);
                                name2 = snapshot.child(scheduleId).child("week 1").child("friday").child("lesson 2").child("teacherName").getValue(String.class);
                                name3 = snapshot.child(scheduleId).child("week 1").child("friday").child("lesson 3").child("teacherName").getValue(String.class);
                                name4 = snapshot.child(scheduleId).child("week 1").child("friday").child("lesson 4").child("teacherName").getValue(String.class);
                                name5 = snapshot.child(scheduleId).child("week 1").child("friday").child("lesson 5").child("teacherName").getValue(String.class);
                                name6 = snapshot.child(scheduleId).child("week 1").child("friday").child("lesson 6").child("teacherName").getValue(String.class);
                                name7 = snapshot.child(scheduleId).child("week 1").child("friday").child("lesson 7").child("teacherName").getValue(String.class);
                                name8 = snapshot.child(scheduleId).child("week 1").child("friday").child("lesson 8").child("teacherName").getValue(String.class);
                                email1 = snapshot.child(scheduleId).child("week 1").child("friday").child("lesson 1").child("teacherEmail").getValue(String.class);
                                email2 = snapshot.child(scheduleId).child("week 1").child("friday").child("lesson 2").child("teacherEmail").getValue(String.class);
                                email3 = snapshot.child(scheduleId).child("week 1").child("friday").child("lesson 3").child("teacherEmail").getValue(String.class);
                                email4 = snapshot.child(scheduleId).child("week 1").child("friday").child("lesson 4").child("teacherEmail").getValue(String.class);
                                email5 = snapshot.child(scheduleId).child("week 1").child("friday").child("lesson 5").child("teacherEmail").getValue(String.class);
                                email6 = snapshot.child(scheduleId).child("week 1").child("friday").child("lesson 6").child("teacherEmail").getValue(String.class);
                                email7 = snapshot.child(scheduleId).child("week 1").child("friday").child("lesson 7").child("teacherEmail").getValue(String.class);
                                email8 = snapshot.child(scheduleId).child("week 1").child("friday").child("lesson 8").child("teacherEmail").getValue(String.class);
